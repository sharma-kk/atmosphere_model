...
xi_data = np.load('./xi_vec_data/xi_matrix_44_eigvec_wei_method_c_1_by_64.npz')
xi_mat = xi_data['xi_mat2']

outfile  = File("./results/xi_vecs_wei.pvd")
...
# Xi1.assign(0)
# Xi1.dat.data[:] += xi_mat[0,:,:]

# Xi2.assign(0)
# Xi2.dat.data[:] += xi_mat[-1,:,:]


# Xi1.rename("Xi_first")
# Xi2.rename("Xi_last")

# outfile.write(Xi1, Xi2)