...
with CheckpointFile("../256x1792/h5_files/grid_256_fields_at_time_t=27.0.h5", 'r') as afile:
...
c_sqr = Constant(1/(128**2)) # averaging solution within box of size 1/128x1/128
...
h5_file = "./h5_files/coarse_grained_vel_temp_at_t=27.0_mesh_128_c_1_by_128.h5"
